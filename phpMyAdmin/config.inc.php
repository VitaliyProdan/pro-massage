...
if ( isset ( $_SESSION["myIntranetAuth"] ) and $_SESSION["myIntranetAuth"] == true)
{
    ...
    $cfg['Servers'][1]['host'] = getenv('OPENSHIFT_MYSQL_DB_HOST');
    $cfg['Servers'][1]['port'] = getenv('OPENSHIFT_MYSQL_DB_PORT');
    ...
    $cfg['ShowAll'] = true;
    $cfg['SaveDir'] = 'd:/openserver/userdata/temp';
    $cfg['TempDir'] = 'd:/openserver/userdata/temp';
    $cfg['UploadDir'] = 'd:/openserver/userdata/temp';
